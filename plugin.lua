function run(msg)
	...
	about_key = {{{text = "وبسایت تیم پایدار" , url = "http://Paydar-robotic.ir"}},{{text = "کانال تیم پایدار" , url = "https://telegram.me/PaydarTeam"}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/omid_paydarBot"}},{{text = "Omid Paydar" , url = "https://telegram.me/Omid_paydar"}}}
